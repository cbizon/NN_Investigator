Entities have many string names.  Going from CURIES(identifiers) to strings, and going from strings to CURIES is the job of the API called name resolver found here:  https://name-resolution-sri-dev.apps.renci.org/docs#.  
